        ...
        newPostForm.submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    let newPost = newPostDom(data.data.post); //caling the function
                    $('#posts-list-container >ul').prepend(newPost); //prepending the post its means post created last come first 
